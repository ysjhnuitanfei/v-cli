 ...
 */
!(function (e, t) {
  typeof exports == 'object' && typeof module == 'object' ? module.exports = t() : typeof define == 'function' && define.amd ? define([], t) : typeof exports == 'object' ? exports.vConsole = t() : e.vConsole = t()
}(this, function () {
  return (function (e) {
    function t (n) {
    ...
    function n (e) {
      ...
      var t = {}
      if (e != null) { for (var o in e) Object.prototype.hasOwnProperty.call(e, o) && (t[o] = e[o]) }
    ...
    var f = o(10),
      ...
      k = (function () {
        function e () {
          ...
          void 0 !== document ? document.readyState == 'complete' ? o() : v['default'].bind(window, 'load', o) : !(function () {
            var e = void 0,
              t = function n () {
                document && document.readyState == 'complete' ? (e && clearTimeout(e), o()) : e = setTimeout(n, 1)
              }
            e = setTimeout(t, 1)
          }())
        }
        return r(e, [{
          ...
          value: function () {
            ...
            v['default'].bind(o, 'touchstart', function (e) {
              var t = o.scrollTop,
                l = o.scrollHeight,
                i = t + o.offsetHeight
              t === 0 ? (o.scrollTop = 1, o.scrollTop === 0 && (v['default'].hasClass(e.target, 'vc-cmd-input') || (n = !0))) : i === l && (o.scrollTop = t - 1, o.scrollTop === t && (v['default'].hasClass(e.target, 'vc-cmd-input') || (n = !0)))
            ...
            e.trigger('init'), e.trigger('renderTab', function (o) {
              ...
              if (t) {
                for (var o = v['default'].one('.vc-tool-last'), n = function (n) {
                    ...
                    l.global == 1 && v['default'].addClass(i, 'vc-global-tool'), d.isFunction(l.onClick) && v['default'].bind(i, 'click', function (e) {
                      l.onClick.call(i)
          ...
          key: 'addPlugin',
          value: function (e) {
            return void 0 !== this.pluginList[e.id] ? (console.warn('Plugin ' + e.id + ' has already been added.'), !1) : (this.pluginList[e.id] = e, this.isReady && (this._initPlugin(e), this.tabList.length == 1 && this.showTab(this.tabList[0])), !0)
          }
        }, {
          key: 'removePlugin',
          value: function (e) {
    ...
    function d (e) {
      return !(Object.prototype.toString.call(e) != '[object Object]' && (n(e) || l(e) || r(e) || i(e) || c(e) || u(e) || a(e) || s(e)))
    }
    ...
    function v (e) {
      return (typeof HTMLElement == 'undefined' ? 'undefined' : y(HTMLElement)) === 'object' ? e instanceof HTMLElement : e && (typeof e == 'undefined' ? 'undefined' : y(e)) === 'object' && e !== null && e.nodeType === 1 && typeof e.nodeName == 'string'
    }
    ...
    var y = typeof Symbol == 'function' && typeof Symbol.iterator == 'symbol' ? function (e) {
      return typeof e
    } : function (e) {
    ...
    t = e.exports = o(8)(), t.push([e.id, 'body{}', ''])
  }, function (e, t) {
    'use strict'
    e.exports = function () {
      var e = []
      return e.toString = function () {
        ...
        for (l = 0; l < t.length; l++) {
          var r = t[l]
          typeof r[0] == 'number' && n[r[0]] || (o && !r[2] ? r[2] = o : o && (r[2] = '(' + r[2] + ') and (' + o + ')'), e.push(r))
        }
      }, e
    }
  }, function (e, t, o) {
    ...
    function i (e, t) {
      var o = g(),
        n = y[y.length - 1]
      if (e.insertAt === 'top') n ? n.nextSibling ? o.insertBefore(t, n.nextSibling) : o.appendChild(t) : o.insertBefore(t, o.firstChild), y.push(t)
      else {
    ...
    function s (e, t) {
      ...
      if (t.singleton) {
        ...
        e.sourceMap && typeof URL == 'function' && typeof URL.createObjectURL == 'function' && typeof URL.revokeObjectURL == 'function' && typeof Blob == 'function' && typeof btoa == 'function' ? (o = c(t), n = v.bind(null, o), l = function () {
    ...
    e.exports = function (e, t) {
      t = t || {}, typeof t.singleton == 'undefined' && (t.singleton = b()), typeof t.insertAt == 'undefined' && (t.insertAt = 'bottom')
      var o = l(e)
      return n(o, t),
      function (e) {
    ...
    var n = (function () {
      ...
      l = (function () {
        ...
        return n(e, [{
          ...
          key: 'trigger',
          value: function (e, t) {
            if (typeof this.eventList[e] == 'function') this.eventList[e].call(this, t)
            else {
        ...
        return a(t, e), s(t, [{
          ...
          value: function () {
            ...
            f['default'].bind(t, 'click', function (o) {
              ...
              f['default'].removeClass(l, 'vc-log-partly-log'), f['default'].removeClass(l, 'vc-log-partly-info'), f['default'].removeClass(l, 'vc-log-partly-warn'), f['default'].removeClass(l, 'vc-log-partly-error'), n == 'all' ? f['default'].removeClass(l, 'vc-log-partly') : (f['default'].addClass(l, 'vc-log-partly'), f['default'].addClass(l, 'vc-log-partly-' + n))
            })
          ...
          key: 'onShow',
          value: function () {
            this.isShow = !0, this.isInBottom == 1 && this.scrollToBottom()
          }
        }, {
          key: 'onHide',
          value: function () {
          ...
          value: function (e) {
            ...
            f['default'].removeClass(t, 'vc-log-partly-log'), f['default'].removeClass(t, 'vc-log-partly-info'), f['default'].removeClass(t, 'vc-log-partly-warn'), f['default'].removeClass(t, 'vc-log-partly-error'), e == 'all' ? f['default'].removeClass(t, 'vc-log-partly') : (f['default'].addClass(t, 'vc-log-partly'), f['default'].addClass(t, 'vc-log-partly-' + e))
          }
        }, {
          key: 'scrollToBottom',
          value: function () {
          ...
          key: 'printOriginLog',
          value: function (e) {
            typeof this.console[e.logType] == 'function' && this.console[e.logType].apply(window.console, e.logs)
          }
        }, {
          key: 'printLog',
          value: function (e) {
            ...
            if (t.length || e.content) {
              ...
              if (u.isString(t[0])) {
                var i = t[0].match(n)
                i !== null && i.length > 0 && (l = i[1].toLowerCase())
              }
              if (l ? o = l == this.id : this.allowUnformattedLog == 0 && (o = !1), !o) return void (e.noOrigin || this.printOriginLog(e))
              ...
              for (var a = f['default'].render(h['default'], {
                ...
                v && (typeof v == 'string' ? s.insertAdjacentHTML('beforeend', v) : s.insertAdjacentElement('beforeend', v))
              }
      ...
      b = (function (e) {
        ...
        return a(t, e), c(t, [{
          ...
          value: function () {
            ...
            t = 'Unknown', a && a[1] ? (t = a[1], r += ', WeChat ' + t, console.info('[system]', 'System:', r)) : console.info('[system]', 'System:', r), t = 'Unknown', t = location.protocol == 'https:' ? 'HTTPS' : location.protocol == 'http:' ? 'HTTP' : location.protocol.replace(':', ''), r = t
            ...
            if (e) {
              ...
              t._open = o, t._send = n, window.XMLHttpRequest.prototype.open = function () {
                ...
                return e.onreadystatechange = function () {
                  var o = t.reqList[i] || {}
                  if (o.url = l, o.readyState = e.readyState, e.readyState == 0) o.startTime = +new Date()
                  else if (e.readyState == 1) o.startTime = +new Date()
                  ...
                  } else e.readyState == 3 || e.readyState == 4 && (o.status = e.status, o.endTime = +new Date(), o.costTime = o.endTime - (o.startTime || o.endTime), o.response = e.response)
